...
export default function EnrollForm() {
    ...
    const filteredSections = sections.filter((section) =>
        selectedCourse === 'BSIT' ? section.id.startsWith('IT') : section.id.startsWith('CS')
    );
    ...
    const enrollData = () => {
        ...
        try {
            axiosClient.post("/enrollment", payload)
                .then(() => {
    ...
    const subjectsData = () => {
        ...
        courses.forEach(course => {
            axiosClient.post("/subject", course)
                .then(() => {
                    console.log("Subjects Form submission successful:");
                })
                .catch(err => {
                    console.error("Subjects Form submission failed:", err.response.data.errors); // Log detailed validation errors
                });
        });
    }
                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-body">
                            <p className="text-center mb-1 mt-0" id="header">Quick Enroll</p>
                            ...
                            <form >
                                ...
                                <div className="mb-3">
                                    ...
                                    <select className="form-select form-select-md" id="section" name="section" required>
                                ...
                                <div className="d-flex justify-content-between">
                                    <Link className="btn btn-secondary" to="/enrollment">
                                        Back
                                    </Link>
                                    <Link type="submit" className="btn btn-primary" onClick={submitData}>
                                        Next
                                    </Link>
                                </div>
