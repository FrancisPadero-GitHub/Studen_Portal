      ...
      <div className="container-fluid">
              ...
              <div className="card-body p-0 d-flex flex-fill">
                <div className="row g-0 w-100">
                  ...
                  <div className="col-6 align-self-end text-end">
                    <img src="/customer-support.jpg" className="img-fluid illustration-img" alt="" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="card border-0">
          <div className="card-header">
            ...
            <h6 className="card-subtitle text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum ducimus, necessitatibus reprehenderit itaque!</h6>
          </div>
